        ...
        generateRoutes() {
            return new Promise(resolve => {
                ...
                getRouters().then(res => {
                    ...
                    // TODO--待优化
                    // 向路由中添加
                    // addRouterItem(this.sidebarRouters)
...
function addRouterItem(routerData) {
    ...
    if (routerData?.length) {
        routerData.forEach(item => {
            ...
            // }
            const routerItemClone = JSON.parse(JSON.stringify(item))
            if (item.name === 'System') {
                const routerChildrenClone = JSON.parse(JSON.stringify(routerItemClone.children))
                routerItemClone.children = []
                console.log('routerChildrenClone', routerChildrenClone)
                console.log('routerItemClone', routerItemClone)
                router.addRoute(routerItemClone)
                routerChildrenClone.forEach(item => {
